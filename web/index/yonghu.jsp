...
<div class="page-wrapper">
        ...
        <nav class="navigation navbar navbar-default">
            <div class="container">
                ...
                <div class="cart-contact">
                    <div class="contact-btn hidden-xs"> <a href="yonghu1.jsp" class="theme-btn">·我·</a> </div>
                </div>
            </div>
            <!-- end of container -->
        </nav>
    ...
    <main>
        ...
        <div id='container'>
            <script type="text/javascript" src="https://webapi.amap.com/maps?v=1.4.15&key=a6c37f3ccdcd86c53d4413f9fc508dd5&plugin=AMap.CitySearch"></script>
                    ...
                    citysearch.getLocalCity(function(status, result) {
                        if (status === 'complete' && result.info === 'OK') {
                            if (result && result.city && result.bounds) {
                                ...
                                document.getElementById('info').innerHTML = 'fuck' + cityinfo;
                                //地图显示当前城市
        ...
        <!--用户操作模块-->
        <div class="a">
            <div class="a1">当前位置:<div class="info"><p id="info1"></p></div> <a href="#">更改</a></div>
